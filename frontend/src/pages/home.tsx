...
const VONTOGY_FAVICON = "https://res.cloudinary.com/dopp0v9eq/image/upload/v1763574787/monfily-black-nobg_risk6t.png";
...
export default function Home() {
  useEffect(() => {
    ...
    if (favicon) {
      favicon.href = VONTOGY_FAVICON;
    }
    
    // Cleanup: restore original values when leaving the page
    return () => {
